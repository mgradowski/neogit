...
function M.setup(config)
  ...
  hl_store = {
    ...
    NeogitGraphWhite               = { fg = palette.white, ctermfg = 15 },
    NeogitGraphYellow              = { fg = palette.yellow, ctermfg = 11 },
    ...
    NeogitGraphGray                = { fg = palette.grey, ctermfg = 8 },
    ...
    NeogitGraphBoldWhite           = { fg = palette.white, bold = palette.bold, ctermfg = 15 },
    NeogitGraphBoldYellow          = { fg = palette.yellow, bold = palette.bold, ctermfg = 11 },
    ...
    NeogitGraphBoldGray            = { fg = palette.grey, bold = palette.bold, ctermfg = 8 },
    ...
    NeogitHunkMergeHeader          = { fg = palette.bg2, bg = palette.grey, bold = palette.bold, ctermfg = 11, ctermbg = 0 },
    NeogitHunkMergeHeaderHighlight = { fg = palette.bg0, bg = palette.bg_cyan, bold = palette.bold, ctermfg = 0, ctermbg = 0 },
    NeogitHunkMergeHeaderCursor    = { fg = palette.bg0, bg = palette.bg_cyan, bold = palette.bold, ctermfg = 0, ctermbg = 0 },
    NeogitHunkHeader               = { fg = palette.bg0, bg = palette.grey, bold = palette.bold, ctermfg = 0, ctermbg = 0 },
    NeogitHunkHeaderHighlight      = { fg = palette.bg0, bg = palette.md_purple, bold = palette.bold, ctermfg = 0, ctermbg = 0 },
    NeogitHunkHeaderCursor         = { fg = palette.bg0, bg = palette.md_purple, bold = palette.bold, ctermfg = 0, ctermbg = 0 },
    NeogitDiffContext              = { bg = palette.bg1, ctermbg = 0 },
    NeogitDiffContextHighlight     = { bg = palette.bg2, ctermbg = 0 },
    NeogitDiffContextCursor        = { bg = palette.bg1, ctermbg = 0 },
    NeogitDiffAdditions            = { fg = palette.bg_green, ctermfg = 10 },
    NeogitDiffAdd                  = { bg = palette.line_green, fg = palette.bg_green, ctermbg = 0, ctermfg = 10 },
    NeogitDiffAddHighlight         = { bg = palette.line_green, fg = palette.green, ctermbg = 0, ctermfg = 2 },
    NeogitDiffAddCursor            = { bg = palette.bg1, fg = palette.green, ctermbg = 0, ctermfg = 2 },
    NeogitDiffDeletions            = { fg = palette.bg_red, ctermfg = 9 },
    NeogitDiffDelete               = { bg = palette.line_red, fg = palette.bg_red, ctermbg = 0, ctermfg = 9 },
    NeogitDiffDeleteHighlight      = { bg = palette.line_red, fg = palette.red, ctermbg = 0, ctermfg = 1 },
    NeogitDiffDeleteCursor         = { bg = palette.bg1, fg = palette.red, ctermbg = 0, ctermfg = 1 },
    ...
    NeogitFilePath                 = { fg = palette.blue, italic = palette.italic, ctermfg = 4 },
    NeogitCommitViewHeader         = { bg = palette.bg_cyan, fg = palette.bg0, ctermbg = 0, ctermfg = 0 },
    NeogitCommitViewDescription    = { link = "String" },
    NeogitDiffHeader               = { bg = palette.bg3, fg = palette.blue, bold = palette.bold, ctermbg = 0, ctermfg = 4 },
    NeogitDiffHeaderHighlight      = { bg = palette.bg3, fg = palette.orange, bold = palette.bold, ctermbg = 0, ctermfg = 3 },
    ...
    NeogitChangeUnmerged           = { fg = palette.bg_yellow, bold = palette.bold, italic = palette.italic, ctermfg = 11 },
    ...
    NeogitTagName                  = { fg = palette.yellow, ctermfg = 11 },
    NeogitTagDistance              = { fg = palette.cyan, ctermfg = 6 },
    NeogitFloatHeader              = { bg = palette.bg0, bold = palette.bold, ctermbg = 0 },
    NeogitFloatHeaderHighlight     = { bg = palette.bg2, fg = palette.cyan, bold = palette.bold, ctermbg = 0, ctermfg = 6 },
    NeogitActiveItem               = { bg = palette.bg_orange, fg = palette.bg0, bold = palette.bold, ctermbg = 0, ctermfg = 0 },
  }
